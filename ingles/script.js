...
function ViewFetch(){
    fetch("https://66fe547d2b9aac9c997b6369.mockapi.io/Ingles")
    .then(res => res.json())
    .then(data =>{
...
async function AddNewAnswer(Q,id) {
    ...
    const response = await fetch(`https://66fe547d2b9aac9c997b6369.mockapi.io/Ingles/${id}`);
    ...
    await fetch(`https://66fe547d2b9aac9c997b6369.mockapi.io/Ingles/${id}`,{
        method: 'PUT',
        headers:{
...
async function AddNewQuestion(Q) {    
    ...
    await fetch('https://66fe547d2b9aac9c997b6369.mockapi.io/Ingles',{
        method: 'POST',
        headers:{
            'Content-Type' : 'application/json',
        },
